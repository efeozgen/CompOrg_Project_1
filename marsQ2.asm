...
travel_numbers_for_loop:
    ...
    loop:
        # t1 - t2 aralarýnda asal mý deðil mi kontrol et
        ...
        second_loop:
            ...
            blt $t6, $s3, second_loop #arrayin uzunluðunun 1 eksiðine eþit deðilse second_loopa geri döndür
    ...
    jr $ra
        ...
        # eðer aralarýnda asal ise t1 ve t2 yi 1er arttýr
        # eðer deðillerse en küçük ortak katlarýný bul
...
# Kullanýcýdan sayýlarý oku ve diziye ekle
read_numbers:
    li $v0, 4
    la $a0, prompt
    syscall
...
print_numbers:
    ...
    # Kontrol elemaný olan -1'e kadar yazdýrmayý bitir
    beq $t0, $zero, CA
    ...
    # Bir sonraki sayýyý yazdýrmak için döngüyü tekrarla
    j print_numbers
